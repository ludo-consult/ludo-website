...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: `A LUDO, entrou para cuidar da nossa gestão financeira, ganhamos muito mais do que uma prestadora de serviços. Ganhamos organização, clareza e tranquilidade para tomar decisões.
          ...
          Os analistas conduzem tudo com muita competência, atenção aos detalhes e profissionalismo, sempre disposta a orientar e encontrar as melhores soluções. É o tipo de parceria que gera confiança e nos permite focar na operação, sabendo que a parte financeira está em excelentes mãos.
